...
;// CONCATENATED MODULE: ./src/js/checkBank.js
...
;// CONCATENATED MODULE: ./src/js/ValidateForm.js
...
var ValidateForm = /*#__PURE__*/function () {
  ...
  _createClass(ValidateForm, [{
    ...
    value: function events() {
      var _this = this;
      this.formInput.addEventListener('input', function (e) {
        return _this.checkInput(e);
      });
    ...
    key: "checkCardNumber",
    value: function checkCardNumber(value) {
    ...
    key: "checkLuhnDom",
    value: function checkLuhnDom(func) {
      if (func) {
    ...
    key: "clearCardStyles",
    value: function clearCardStyles() {
    ...
    value: function formSubmit(e) {
      e.preventDefault();
      this.clearMessages();
      var num = this.formInput.value.replace(/ /g, '');
    ...
    key: "showBank",
    value: function showBank(bankName) {
      this.cards.forEach(function (item) {
        item.classList.add('cards-opacity');
      });
      if (!bankName) return false;
      document.querySelector(".".concat(bankName)).closest('.cards-opacity').classList.remove('cards-opacity');
      return true;
    }
  }, {
    key: "showNoBankError",
    value: function showNoBankError() {
      this.noBankError.classList.add('display');
    }
  }, {
    key: "showNumCheckError",
    value: function showNumCheckError() {
...
;// CONCATENATED MODULE: ./src/js/CheckCardFormWidget.js
...
function CheckCardFormWidget_typeof(obj) { "@babel/helpers - typeof"; return CheckCardFormWidget_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, CheckCardFormWidget_typeof(obj); }
function CheckCardFormWidget_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function CheckCardFormWidget_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, CheckCardFormWidget_toPropertyKey(descriptor.key), descriptor); } }
function CheckCardFormWidget_createClass(Constructor, protoProps, staticProps) { if (protoProps) CheckCardFormWidget_defineProperties(Constructor.prototype, protoProps); if (staticProps) CheckCardFormWidget_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function CheckCardFormWidget_toPropertyKey(arg) { var key = CheckCardFormWidget_toPrimitive(arg, "string"); return CheckCardFormWidget_typeof(key) === "symbol" ? key : String(key); }
function CheckCardFormWidget_toPrimitive(input, hint) { if (CheckCardFormWidget_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (CheckCardFormWidget_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }

var CheckCardFormWidget = /*#__PURE__*/function () {
  function CheckCardFormWidget(parentEl) {
    CheckCardFormWidget_classCallCheck(this, CheckCardFormWidget);
    this.parentEl = parentEl;
  }
  CheckCardFormWidget_createClass(CheckCardFormWidget, [{
    key: "bindToDOM",
  ...
  return CheckCardFormWidget;
}();

;// CONCATENATED MODULE: ./src/js/app.js

var validateForm = document.querySelector('.validate-form');
var widget = new CheckCardFormWidget(validateForm);
widget.bindToDOM();
